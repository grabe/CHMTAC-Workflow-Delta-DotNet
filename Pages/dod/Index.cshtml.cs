...
namespace CHMR_DMP_PPR_Charlie_Docker.Pages.dod
{
    [ResponseCache(NoStore = true, Location = ResponseCacheLocation.None)]
    public class DodIndexModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            return CHMR_DMP_PPR_Charlie_Docker.Configuration.ConfigurationPoco.IsLoggedOn ? RedirectToPage(Role.ToString().ToLower()+"/index") : RedirectToPage("/Public/chirf");
        }
    }
}
